...
export class Leaderboard {
    ...
    buildLeaderboard(players) {
        ...
        for (let i in players) {
            this.entries.push(new LeaderboardEntry(players[i].id, players[i].username, players[i].score, players[i].tankoidPreset)) // temporarily the id is the same as the name
        }
